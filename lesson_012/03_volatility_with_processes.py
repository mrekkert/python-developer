...
class Exchange(Process):
    ...
    def run(self):
        ...
        self.collector.put(round(self.volatility, 2))
...
def main():
    ...
    for item in file:
        ...
        exchange = Exchange(file_name=trades, collector=collector)
    ...
    for ticker in object_lst:
        name_lst.append(str(ticker))
        lst.append(ticker.collector.get())
